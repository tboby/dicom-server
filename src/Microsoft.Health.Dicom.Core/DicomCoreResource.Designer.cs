...
namespace Microsoft.Health.Dicom.Core {
    ...
    internal class DicomCoreResource {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Implicit Value Representation is not allowed. Error in Dicom Tag {0}..
        /// </summary>
        internal static string ImplicitVRCodeNotAllowed {
            get {
                return ResourceManager.GetString("ImplicitVRCodeNotAllowed", resourceCulture);
            }
        }
